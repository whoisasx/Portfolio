		...
		<div className="relative py-5 px-3">
			...
			<div className="project-card-content">
				...
				<p className="project-summary">
					Short, crisp description of the project. Replace this with a
					concise summary of what the project does and why it matters.
				</p>
				<ul className="project-meta">
					...
					<li>
						<strong>Tech:</strong> React, Next.js, Tailwind
					</li>
					<li>
